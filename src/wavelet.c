...
int D4_wavelet_2D( double ** sca_sca, double ** sca_wav, double ** wav_sca, double ** wav_wav, double * array, int len_row, int len_col){
	...
	D4_wavelet_forward_rows( &hor_scale, &hor_wavelet, array, len_row, len_col);
	D4_wavelet_forward_columns( sca_sca, sca_wav, hor_scale, len_row, len_col/2);
	D4_wavelet_forward_columns( wav_sca, wav_wav, hor_wavelet, len_row, len_col/2);
...
int D4_wavelet_2D_CR( double ** sca_sca, double ** sca_wav, double ** wav_sca, double ** wav_wav, double * array, int len_row, int len_col){
	...
	D4_wavelet_forward_columns( &ver_scale, &ver_wavelet, array, len_row, len_col);
	D4_wavelet_forward_rows( sca_sca, sca_wav, ver_scale, len_row/2, len_col);
	D4_wavelet_forward_rows( wav_sca, wav_wav, ver_wavelet, len_row/2, len_col);
...
int compute_backward_filter(double ** filter_dst, double * filter_src, int filter_length){
